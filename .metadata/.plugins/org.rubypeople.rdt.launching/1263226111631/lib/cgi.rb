...
Class methods:
--------------
     cookie, error, escape, escape, escapeElement, escapeHTML,
     escapeHTML, header, message, new, new, parse, pretty, print,
     rfc1123_date, rfc1123_date, tag, unescape, unescape,
