...
-----------------
     ...
     define_method, extend_object, extended, freeze, include, include?,
     included, included_modules, instance_method, instance_methods,
     method_added, method_defined?, method_removed, method_undefined,
     module_eval, module_function, name, private, private_class_method,
